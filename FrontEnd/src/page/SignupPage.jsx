...
const signupSchema = z.object({
  ...
  password: z.string().min(6, "Password must contains atleast 6 letters"),
  name: z.string().min(3, "Name must contains atleast 3 letters"),
});
  ...
  return (
    <div className="h-screen grid lg:grid-cols-2">
      ...
      <AuthImagePattern
        ...
        subtitle={"Sign up and access our platform and start using our services"}
      />
    </div>
  );
};
